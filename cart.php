<?php
session_start();
$koneksi = mysqli_connect("localhost", "root", "", "binvapestore");
...
if (isset($_GET["action"])) {
    if ($_GET["action"] == "delete") {
        foreach ($_SESSION["cart"] as $keys => $value) {
            ...
            $sql = mysqli_query($koneksi, "INSERT INTO dibeli(tgl_transaksi,id_pembeli,usernamerga,total_barang) value ('".date("Y-m-d")."','$id_pembeli','$username','$alamat','$total_harga','$total_barang')");
            //$sql = mysqli_query($koneksi, "INSERT INTO dibeli(total_harga,total_barang,tgl_transaksi,id_pmbeli,alamat) value ('".date("y-m-d")."','$id_pembeli','$alamat')");
            //$sql = mysqli_query($koneksi, "INSERT INTO dibeli(total_tal_barang,tgl_transaksi,id_pembeli,alamat) VALUES ('$total','".date("Y-m-d")."','$id_pembeli','$alamat')");
            }
                                            ...
                                            <div class="row  justify-content-between">
                                                <div class="col-auto col-md-7">
                                                    <div class="media flex-column flex-sm-row">
                                                        <img class="rouned" src="foto/<?= $value['foto']; ?>" width="62" height="62">
